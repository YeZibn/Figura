...
not mean that review passed or that publication succeeded. Run lifecycle events
SHALL additionally distinguish active, completed, failed, and interrupted
states, and interruption reason SHALL remain separate from tool, review, and
