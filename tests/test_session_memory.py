...
def test_authorized_chart_tools_keep_identity_and_hide_local_paths():
    ...
    expected_fields = {
        ...
        "measure_bars": {"attachment_id", "panel_id", "measurement_target"},
        "extract_line_series": {"attachment_id", "panel_id", "measurement_target"},
        "extract_pie_slices": {"attachment_id", "panel_id", "measurement_target"},
        "extract_scatter_points": {"attachment_id", "panel_id", "measurement_target"},
    }
