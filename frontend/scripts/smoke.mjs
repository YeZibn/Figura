...
checks.push(['measurement repair required event', 'measurement_repair_required'], ['measurement repair rejected event', 'measurement_repair_rejected'], ['measurement repair exhausted event', 'measurement_repair_exhausted'], ['measurement repair event kinds', 'measurementRepairEventKinds'], ['measurement repair summary', 'measurementRepairSummary'], ['measurement repair required label', '需要定向重测'], ['measurement repair rejected label', '定向重测被拒绝'], ['measurement repair exhausted label', '定向重测次数已用尽'], ['measurement repair mock sample', 'run_mock_repair'], ['measurement repair replay merge', 'mergeEvents'], ['measurement repair reconnect', 'scheduleReconnect'])
...
checks.push(['evaluation detail API', 'getEvaluationHistoryDetails'], ['evaluation detail route', '/history/details'], ['evaluation detail DTO', 'EvaluationHistoryDetails'], ['evaluation conversation disclosure', '展开对话与工具详情'], ['evaluation detail truncation state', '本次详细记录受大小上限保护'], ['evaluation sensitive notice', 'props.details.notice'], ['evaluation detail preview mapping', 'mapEvaluationDetailEntry'])
