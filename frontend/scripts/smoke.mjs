...
checks.push(['persisted execution history', 'getRunHistory'], ['run-level disclosure', 'RunTimeline'], ['call correlation', 'call_id'], ['cursor recovery', 'afterSequence'], ['history gap state', 'historyGap'], ['safe Markdown', 'SafeMarkdown'], ['answer source fallback', 'answer-source'])
