...
const source = app + gateway + client + attachmentHelpers + stylesheet + runtime + mock + launcher + tauriLauncher + tauriConfig + tauriEntrypoint + tauriPackage + pythonPackage + readme
...
checks.push(['persisted execution history', 'getRunHistory'], ['run-level disclosure', 'RunTimeline'], ['call correlation', 'call_id'], ['cursor recovery', 'afterSequence'], ['history gap state', 'historyGap'], ['safe Markdown', 'SafeMarkdown'], ['answer source fallback', 'answer-source'], ['generated chart event', 'generated_chart'], ['generated artifact URL', 'generatedArtifactUrl'], ['generated chart preview', 'GeneratedChartView'], ['generated chart download', '下载 PNG'])
