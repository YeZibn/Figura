...
export const mockDemoRun: RunSummary = { runId: 'run_mock_demo', sessionId: 'chart-analysis', status: 'completed', createdAt: '2026-09-13T10:39:00+08:00', updatedAt: '2026-09-13T10:40:00+08:00', eventCount: 11, provider: 'openai', model: 'gpt-4o-mini', answer: '这张图表包含三个类别：Alpha 为 8，Beta 为 16，Gamma 为 24。测量得到的柱高约为 1:2:3，与图中打印的数值一致。' }
...
export const mockDemoEvents: AgentRunEvent[] = [
  ...
  { runId: mockDemoRun.runId, sequence: 3, kind: 'tool_result', timestamp: '2026-09-13T10:39:30+08:00', payload: { ...mockLoadUnit, call_id: 'demo-load', status: 'success', tool_name: 'load_image', result: { observations: 1 } } },
  ...
  { runId: mockDemoRun.runId, sequence: 8, kind: 'chart_staged', timestamp: '2026-09-13T10:40:20+08:00', payload: { correlation_version: 2, unit_id: 'generation:stg_demo_chart', unit_type: 'generation', phase: 'render', actor: 'tool', role: 'action', transition_id: 'generation:stg_demo_chart:staged', call_id: 'demo-render', state: 'staged', staged_ref: 'stg_demo_chart', chart_type: 'bar', title: '季度销售重绘', caption: '生成图表：季度销售重绘', media_type: 'image/png', byte_count: mockImage.length, width: 640, height: 360, imageUrl: mockImage } },
  { runId: mockDemoRun.runId, sequence: 9, kind: 'chart_verification_result', timestamp: '2026-09-13T10:40:21+08:00', payload: { correlation_version: 2, unit_id: 'verification:ver_demo_chart', unit_type: 'verification', parent_unit_id: 'generation:stg_demo_chart', phase: 'verify', actor: 'system', role: 'verification', transition_id: 'verification:ver_demo_chart:completed', staged_ref: 'stg_demo_chart', verification_ref: 'ver_demo_chart', state: 'pass', verification: { verificationRef: 'ver_demo_chart', stagedRef: 'stg_demo_chart', manifestDigest: 'mock-manifest-digest', policyVersion: 1, status: 'pass', checks: { structure: 'pass', encoded_artifact: 'pass' }, issues: [], decision: 'pass', confidence: 1, attempt: 1 } } },
  { runId: mockDemoRun.runId, sequence: 10, kind: 'chart_promotion_result', timestamp: '2026-09-13T10:40:22+08:00', payload: { correlation_version: 2, unit_id: 'artifact:artifact_mock_chart', unit_type: 'artifact', parent_unit_id: 'generation:stg_demo_chart', phase: 'publish', actor: 'system', role: 'artifact', transition_id: 'artifact:artifact_mock_chart:published', staged_ref: 'stg_demo_chart', verification_ref: 'ver_demo_chart', artifact_id: 'artifact_mock_chart', state: 'published', imageUrl: mockImage, downloadUrl: mockImage } },
  { runId: mockDemoRun.runId, sequence: 11, kind: 'final_answer', timestamp: '2026-09-13T10:40:25+08:00', payload: { answer: mockDemoRun.answer } },
]
