...
export const mockRepairDemoRun: RunSummary = { runId: 'run_mock_repair', sessionId: 'sales-review', status: 'failed', createdAt: '2026-09-14T16:10:00+08:00', updatedAt: '2026-09-14T16:12:00+08:00', eventCount: 7, provider: 'qwen', model: 'qwen3.8-flash', terminalCode: 'measurement_repair_exhausted', terminalMessage: '定向重测次数已用尽' }
...
export const mockRepairDemoEvents: AgentRunEvent[] = [
  ...
  { runId: mockRepairDemoRun.runId, sequence: 2, kind: 'tool_result', timestamp: '2026-09-14T16:10:40+08:00', payload: { unit_id: 'measurement:repair-measure-1', unit_type: 'measurement', phase: 'action', actor: 'tool', role: 'action', transition_id: 'measurement:repair-measure-1:completed', tool_name: 'measure_bars', call_id: 'repair-measure-1', state: 'completed', status: 'success', result: { measurement: 'quality_gate_required' } } },
  { runId: mockRepairDemoRun.runId, sequence: 3, kind: 'measurement_repair_required', timestamp: '2026-09-14T16:10:41+08:00', payload: { unit_id: 'measurement:matt_1', unit_type: 'measurement', phase: 'repair', actor: 'system', role: 'gate', transition_id: 'measurement:matt_1:repair_required', state: 'repair_required', tool_name: 'measure_bars', call_id: 'repair-measure-1', repair: { attachment_id: 'att_demo_chart', panel_id: 'panel_left_bars', parent_attempt_id: 'matt_1', target: { region_kind: 'baseline', fields: ['baseline', 'bars.measure'] }, status: 'available', next_action: '在同一 panel 内重新测量' } } },
  { runId: mockRepairDemoRun.runId, sequence: 4, kind: 'measurement_repair_rejected', timestamp: '2026-09-14T16:11:05+08:00', payload: { unit_id: 'measurement:matt_1', unit_type: 'measurement', phase: 'repair', actor: 'system', role: 'gate', transition_id: 'measurement:matt_1:repair_rejected', state: 'rejected', call_id: 'repair-measure-1', panel_id: 'panel_left_bars', parent_attempt_id: 'matt_1', status: 'rejected', code: 'measurement_target_invalid', reason: '目标区域不再属于当前面板', next_action: '重新读取当前 panel 的 repair_action' } },
  { runId: mockRepairDemoRun.runId, sequence: 5, kind: 'measurement_repair_required', timestamp: '2026-09-14T16:11:20+08:00', payload: { unit_id: 'measurement:matt_2', unit_type: 'measurement', phase: 'repair', actor: 'system', role: 'gate', transition_id: 'measurement:matt_2:repair_required', state: 'repair_required', call_id: 'repair-measure-2', repair: { panel_id: 'panel_left_bars', attempt_id: 'matt_2', parent_attempt_id: 'matt_1', target: { region_kind: 'bar_group' }, status: 'available', budget_remaining: 1, next_action: '在同一面板内重新测量柱体和基准线' } } },
  { runId: mockRepairDemoRun.runId, sequence: 6, kind: 'measurement_repair_exhausted', timestamp: '2026-09-14T16:11:50+08:00', payload: { unit_id: 'measurement:matt_2', unit_type: 'measurement', phase: 'repair', actor: 'system', role: 'gate', transition_id: 'measurement:matt_2:repair_exhausted', state: 'exhausted', call_id: 'repair-measure-2', panel_id: 'panel_left_bars', attempt_id: 'matt_2', parent_attempt_id: 'matt_1', status: 'exhausted', budget_remaining: 0, reason: '定向重测未收敛', next_action: '保留失败证据并停止定向重测' } },
  { runId: mockRepairDemoRun.runId, sequence: 7, kind: 'run_failed', timestamp: '2026-09-14T16:12:00+08:00', payload: { code: mockRepairDemoRun.terminalCode, message: mockRepairDemoRun.terminalMessage } },
]
